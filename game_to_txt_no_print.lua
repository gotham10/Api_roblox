...
task.spawn(function()
	...
	crawlForScripts = function(instance)
		...
		if success and isScript then
			...
			updateStatus("Processing: " .. path, Color3.new(0.9, 0.9, 0.9))
			task.wait()
	...
	updateStatus("Initializing...", Color3.new(1, 1, 0))
	...
	updateStatus("Required functions found. Starting...", Color3.new(0.5, 1, 0.5))
	task.wait(1.5)
	...
	if #ALL_SCRIPTS_DATA == 0 then
		updateStatus("No scripts were found.", Color3.new(1, 1, 0))
		task.wait(5)
		StatusGui:Destroy()
		return
	end
